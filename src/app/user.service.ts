...
export class UsersService {
  ...
  private USER_SERVICE_BASE_URL = 'http://localhost:8081/api/user';

  private CREATEUSER = 'http://localhost:8081/registration';
  private AUTHENTICATE = 'http://localhost:8081/login';
